...
# 读取数据集
df = pd.read_csv(r'美元股票价格和信息数据集.csv')
...
print("未来15分钟内的价格预测:", future_price[0])
...
plt.plot(X_test.index, y_test, label='实际价格', color='blue')
plt.plot(X_test.index, y_pred, label='预测价格', color='red')
plt.title('实际价格 vs 预测价格', fontproperties=font)
